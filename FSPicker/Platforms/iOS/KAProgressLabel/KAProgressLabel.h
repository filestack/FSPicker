...
- (void)setCustomFillColor:(UIColor *)color UI_APPEARANCE_SELECTOR;
- (void)setCustomTrackColor:(UIColor *)color UI_APPEARANCE_SELECTOR;
- (void)setCustomProgressColor:(UIColor *)color UI_APPEARANCE_SELECTOR;
